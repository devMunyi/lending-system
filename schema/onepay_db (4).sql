...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 19, 2021 at 04:55 PM
...
INSERT INTO `o_campaigns` (`uid`, `name`, `description`, `running_date`, `target_customers`, `added_date`, `added_by`, `status`) VALUES
(1, 'Test Campaign', 'Just testing', '2021-07-22', 2, '2021-07-19 12:21:08', 1, 1),
(2, 'Holiday Greetings', 'Send to customers', '2021-07-20', 2, '2021-07-19 12:35:30', 1, 1);
...
(1, 'Birthdays', 'Send Birthday Wishes', '', 1),
(2, 'Activate Old Customers', 'Send a message to all customers who have not taken a loan is 3 months', '', 1);
...
(66, 1, 'Mtq0VUwdXKdqez4DPBnQ9s5s6SYl6ZE1843d4gfGC2NjN97Ako64hFAnvAnsAC9H', '2021-07-10 10:12:15', '2021-08-09 00:00:00', '', '', '', '', 0, 1),
(67, 1, 'kXauXr2rK3En1HLJC9mPMH21bDxvwjqpyo4qdhbN4WwD5RPYURLDAlPkyZ8ILqlU', '2021-07-15 16:21:49', '2021-08-14 00:00:00', '', '', '', '', 0, 1);
...
--
-- Indexes for table `o_campaign_target_customers`
--
ALTER TABLE `o_campaign_target_customers`
  ADD PRIMARY KEY (`uid`),
...
--
-- AUTO_INCREMENT for table `o_campaign_target_customers`
--
ALTER TABLE `o_campaign_target_customers`
  MODIFY `uid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `o_tokens`
  MODIFY `uid` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
